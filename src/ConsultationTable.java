...
public class ConsultationTable implements ActionListener {
    JFrame frame;
    JButton button;
    final String col[] ={"PatientID", "DoctorID", "Date", "Time", "Cost", "Notes"};
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button) {
            String line = null;
            try {
                File file = new File("ConsultationTime.txt");
